...
export const DeleteButton = ({onClick}: {onClick: (keys: string[]) => void}) => {
  ...
  return (
    <AdminContentLayout>
      ...
      <AdminContentLayout.Slot name="Content">
        ...
        >
          <Selection  mode="none"/>
          <Column dataField={'fake'} caption={'dxCheckBox'}
                  cellRender={(e: any) => {
                    console.log(e)
                    const {data, row: {isSelected, rowIndex}, value, key} = e
                    return <SelectionCheckBox isSelected={isSelected} key={key} gridRef={gridRef} rowIndex={rowIndex}/>
                  }}
                  dataType={'boolean'}
          >
          </Column>
          ...
          <Toolbar>
            <ToolbarItem 
              location={"before"}
              render={(e: any) => {
                return (<DeleteButton onClick={(keys: string[]) => console.log(keys)}/>)
              }}
            />
          </Toolbar>
