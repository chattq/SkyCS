import DataGrid, {
  ...
  ColumnChooser,
  ColumnFixing,
  HeaderFilter, Item as ToolbarItem,
  Pager,
  Paging,
  Scrolling,
  Selection, Toolbar
...
export const SearchDataGrid = forwardRef((
  {
    columns, dataSource, keyExpr,
    onSelectionChanged,
    toolbarItems,
    storeKey
  }: SearchDataGridProps, ref: any) => {
  ...
  const handleSelectionChanged = ({selectedRowKeys, selectedRowsData}: any) => {
