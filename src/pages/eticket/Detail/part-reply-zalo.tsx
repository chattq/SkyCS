        ...
        <div className={'w-full message-reply mb-2'}>
            <div className="w-full p-2 mb-3">
                <div className="flex float-left ml-5">
                    <span className="text-gray mr-2">Địa chỉ nhận <span className="text-red">*</span></span>
                    <DropDownBox
                        label="091234567"
                        style={{ width: 200 }}
                    >
                ...
                <div className="flex float-right mr-5">
                    <span className="text-gray mr-2">Mẫu tin nhắn Zalo <span className="text-red">*</span></span>
                    <DropDownBox
                        label="091234567"
                        style={{ width: 200 }}
                    >
