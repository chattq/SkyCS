...
import { DropDownBox, ButtonGroup, Button, List } from "devextreme-react";
import { Eticket } from "@/packages/types";
import { dataFormAtom } from "@/pages/Department_Control/components/store";
        ...
        <div className={'w-full flex flex-col sep-bottom-5 pl-5 pr-5 pt-2 pb-2'}>
            ...
            <div className={'w-full position-relative mb-2'}>
                ...
                <div className={'position-absolute'} style={{ "top": "-10px", right: "-30px" }}>
                    <span className={'sp-warning'}><i className="dx-icon-warning"></i> Quá hạn 2 ngày</span>
                </div>
            </div>
            <div className={'w-full'} style={{ minHeight: "60px" }}>
                ...
                >
                    ...
                    <Item >
                        ...
                        />
                        <div className="flex">
                            <Avatar name={data.Customer.Name} img={data.Customer.Image} size={"sm"} className="mr-1" />
                            <div>
