...
export default function Zalo_channel({ data, setFlagZalo }: any) {
  ...
  const idocUrl = `https://oauth.zaloapp.com/v4/oa/permission?app_id=${import.meta.env.VITE_ZALO_APPID}&redirect_uri=${import.meta.env.VITE_DOMAIN}%2Fzalo-login-callback`;
      ...
      <div className="p-5">
        <div style={{ textAlign: 'left' }}>
          ...
          {customApp && <>
            ...
            <TextBox className="mb-3" width={300} value={appId}
              onValueChange={(e: any) => { setAppId(e) }}
            ></TextBox>
            <span>Zalo App secret</span>
            <TextBox mode="password" className="mb-3" width={300} value={appSecret}
              onValueChange={(e: any) => { setAppSecret(e) }}
            ></TextBox>
          </>}
