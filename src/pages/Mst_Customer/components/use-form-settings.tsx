...
import { Mst_CarModel, Mst_CarSpec, Mst_Dealer } from "@/packages/types";
...
export const useFormSettings = ({
  ...
  const columns = inputColumns.map((c) => {
    ...
    if (["mcm1_ModelNameCondition", "mcm2_ModelNamePromotion"].includes(c.dataField) ) {
      return {
        ...c,
        visible: true,
        editorOptions: {
    ...
    if (["mcs1_SpecDescriptionCondition","mcs2_SpecDescriptionPromotion"].includes(c.dataField)) {
      return {
        ...c,
        visible: true,
        editorOptions: {
