...
export const BaseCardView = ({
  ...
  return (
    <div>
      <PaginationCardView dataSource={dataSource} customCard={customCard} />
    </div>
  );
};
...
export const PaginationCardView = ({
  ...
  const defaultDataSource = [3, 10, 20, 50, 100];
  ...
  return (
    <div className="h-full">
      {dataSource && dataSource.length > 0 && (
        <>
          {" "}
          <div className="flex items-center gap-1 justify-end pr-2 my-2">
            <div>Hiển thị</div>
            <SelectBox
